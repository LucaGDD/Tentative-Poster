---
title: "Cluster Profamille Ile de France"
author: E. Valladier [1], D.Willard [2], MC Bralet [3], O Canceil [4], Y Morvan [5],
  Y Hodé [6]
subtitle: Evaluation de l’impact du programme Profamille par modélisation en réseaux
output:
...
institution:
- id: '1'
  institution: SHU - C3RP, GHU Paris Psychiatrie et Neurosciences
- id: '2'
  institution: CHI Clermont de l’Oise, CRISALID
- id: '3'
  institution: Hôpitaux de Saint Maurice
- id: '4'
  institution: Laboratoire CLIPSYD, EA4430, UFR SPSE, Université Paris Nanterre
- id: '5'
  institution: IPNP - INSERM UMR 1266, LPMP, Université de Paris
- id: '6'
  institution: Réseau Profamille
---

![](images/Picture%201-01.png){width="293"}
...
![](images/Graphreseau_correlation.png){width="583"}

![](images/Reseau_bayesien.png){width="349"}
...
Ces analyses nous permettent
d'observer que chez les aidants la fréquence du souci augmenterait la
difficulté à maitriser les soucis, et les problèmes de concentration
augmenterait la fatigue liée aux soucis. Ces résultats suggèrent donc que les
variables étudiées pourraient effectivement êtres considérés comme des
prédicteurs potentiels de la dépression chez les aidants d'une part et que,
d'autre part, tant la psychoéducation concernant les troubles schizophréniques
de leurs proches que la diminution du coping inadapté constituent des cibles
pertinentes d'intervention.

[**Bibliographie:**]{.ul}

[1] Lucksted A, McFarlane W, Downing D, Dixon L. J
Marital. Recent developments in family psychoeducation as an evidence-based practice. Fam
Ther.
2012.

[2] Valladier E, Willard D, Romo
L, et al.. La dépression chez les proches de patients souffrant de
schizophrénie : effets longitudinaux sur 8 mois du programme Profamille. Encephale. 2017.

[3] Hodé
Y, Krychowski R, Beck N, et al. Effet d'un programme psychoéducatif sur l'humeur es familles des malads souffrant de schizophrénie. J de Thérapie Comportementale et
Cognitive. 2008.

[4] Epskamp S, Borsboom
D, Fried E. Estimating psychological networks and their accuracy: A tutorial
paper. Behav
Res Methods 2018.

[5] Van Borkulo
CD, Boschloo L, Kossakowski JJ, Tio P, Schoevers
RA, Borsboom D, et al. Comparing network structures
on three aspects: A permutation test.

[6] McNally RJ. Can network
analysis transform psychopathology? Behav Res Ther 2016.
